                            ...
                            <div class="card-body p-4">
                                ...
                                ?>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control" name="tfStockInDate" id="tfStockInDate" value="<?php echo date("Y-m-d"); ?>" autocomplete="off" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                ...
                                ?>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4">Stock In Date</label>
                                            <input type="date" class="form-control" name="tfStockInDate" id="tfStockInDate" value="<?php echo date("Y-m-d"); ?>" autocomplete="off" required disabled>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputAddress">Quantity</label>
                                            <input type="number" class="form-control" name="tfQuantity" id="tfQuantity" value="<?php if (isset($serialKeyArr)) {
