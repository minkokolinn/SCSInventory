...
if (isset($_REQUEST['pidtodel'])) {
    ...
    if(confirm('Are you sure to delete?')){
      location='customermng.php?pidtodelConfirm=$pidtodel';
    }else{
      location='customermng.php';
    }
    </script>";
}
//DO ACTION TO DELETE
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody id="myTable">
                    ...
                    $result=$supplierObj->getAllPerson("customer");
                    if ($result=="noresult") {
                        ...
                        foreach ($result as $person) {
                            ...
                            if ($userObj->person=="rw") {
                              echo "
                                <a href='customermng.php?pidtodel=$personId' class='btn btn-danger' title='Delete'><i class='fas fa-trash'></i></a>
                                <a href='personupdate.php?pidtoupd=$personId&&pupdfrom=c' class='btn btn-secondary' title='Edit'><i class='fas fa-pen'></i></a>
                                ";
                            }
                            echo "    
                            </td></tr>
